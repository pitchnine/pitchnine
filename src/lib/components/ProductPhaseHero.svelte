<script>
  ...
  /* ---- Foreground content ---- */
  export let headline = "Growth requires judgement.";
  export let subhead = "When backlog, pilots, and priorities collide, smart growth comes down to timing and discipline.";
